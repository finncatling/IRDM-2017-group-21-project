...
# The interview with winning team said "created two runs of 3-fold cross-validation with disjoint search terms among
# the folds, and one 3-fold cross-validation with disjoint product id sets" ('product_uid')
#
x_train_, y_train_, x_val, y_val = funcs.split_val_set(x_train, y_train, 0.3, 'search_term')
...
common_elements = list(set(val_values).intersection(train_values))
