external_data_dict = {
    ...
    'chrome/polished brass 2-handle 4-in centerset bathroom fauc':
        'chrome/polished brass 2-handle 4-in centerset bathroom faucet',
    ...
    '1/2 in. fip x 7/16 in. or 1/2 in. slip joint angle stop valv':
        '1/2 in. fip x 7/16 in. or 1/2 in. slip joint angle stop valve',
    ...
    'altra furniture parsons credenza desk with drawer and bookc':
        'altra furniture parsons credenza desk with drawer and books',
    ...
    'diverter 5 in. tub spout with slip fit connection in chrom':
        'diverter 5 in. tub spout with slip fit connection in chrome',
    ...
    'american-standarfairfield elongated one-piece 1.6 gpf toilet':
        'american-standard fairfield elongated one-piece 1.6 gpf toilet',
    ...
    'toilet repair kit cadet 3 flowise 2-piece 1.28 gpf round fro':
        'toilet repair kit cadet 3 flowise 2-piece 1.28 gpf round front',
    ...
    'hampton bay reswood valley 5 pc patio seating set with fire':
        'hampton bay redwood valley 5 pc patio seating set with fire',
    ...
    'anderson storm door series 2500 sandtone polished brass':
        'andersen storm door series 2500 sandstone polished brass',
    ...
    '1/4 in.-20 x 1 in. stainless steel flat-head socket cap scre':
        '1/4 in.-20 x 1 in. stainless steel flat-head socket cap screw',
    ...
    'screen doors: screen tight doors 32 in. unfinished wood t-ba':
        'screen doors: screen tight doors 32 in. unfinished wood t-bar',
    ...
    'caroilne avenue 36 in single vanity in white marble top in l':
        'caroline avenue 36 in single vanity in white marble top in l',
    ...
    'leviton - decora 3 gang midway nylon wall plate - light almo':
        'leviton - decora 3 gang midway nylon wall plate - light almond',
    ...
    'textured 6 pannel hollow core primed composite prehung inter':
        'textured 6 panel hollow core primed composite prehung inter',
    ...
    "rumbl;estone": "rumblestone",
    "6' weather shield": "6' weathershield",
    ...
    "cats ": "pets ",
    "chase lounge": "chaise lounge",
    "charbroi l": "char broil",
    "charbroil": "char broil",
    "chibli": "chili",
    "chissel": "chisel",
    "closet maiid": "closetmaid",
    "caseing": "casing",
    "enchors": "anchor s",
    "concrete bled": "concrete blend",
    "rust o leum": "rust oleum",
    "concrete saw": "concrete saw blade cutter",
    "congolium": "congoleum",
    ...
    "cranner": "crane",
    "cupboards": "cabinet",
    "hardiebacker": "hardie backer",
    "cutoff": "cut off",
    "dal tile ": "daltile ",
    "dampiner": "dampener",
    "daylillies": "Daylily daylillies",
    "decostrip": "deco strip",
    "dehumidifyer": "dehumidifier",
    "delata": "delta",
    "ranshower": "ran shower",
    "empact": "e impact",
    ...
    "doggie": "dog",
    "knobsw": "knob sw",
    "latch uard": "latch guard",
    "stopper": "stop",
    "doorbell": "door bell",
    "spoutts": "spout",
    "drainage": "drain",
    "dream line": "dreamline",
    "ppanel": "panel",
    "desighn": "design",
    "el 90deg hxh": "90 degree hxh",
    "elrctric": "electric",
    ...
    "frog tape": "frogtape",
    "furnance": "furnace",
    "galvanisedround": "galvanised round",
    "geotextile ": "geotextile fabric",
    "glue": "adhesive",
    "greased lightning": "greased lightning degreaser",
    "gwtters": "gutters",
    "hacksaw": "hack saw",
    "headlamps": "headlamps led",
    "dutty": "duty",
    ...
    "kholerhighland": "kholer highland",
    ...
    " lazer ": " laser ",
    "tab;le": "table",
    "buggy beds": "buggybeds",
    "wjth": " ",
    "cablrail": "cabl rail",
    " iii ": " 3 ",
    "centerpise": " ax centerpiece",
    "chain saw": " chainsaw ",
    "chair molding": "chair moulding",
    " decke ": " decker ",
    ...
    "sch40": "sch. 40",
    "3 way": "3-way",
    "1/4 od 1/4": "1/4 o.d. 1/4",
    " blde": " blade",
    " elec ": " electrical ",
    " elec.": " electrical ",
    "100 00 btu": "100,00 btu",
    "10000": "100,00 btu",
    "-packs": " pack",
    "-pack": " pack",
    "-peice": " pecice",
